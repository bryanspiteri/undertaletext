...
public class OggClip {
	 ...
	 */
	public OggClip(InputStream in, String location) throws IOException {
		init(in);
	...
	/*
	 * Gets the location of the loaded sound
	 */
